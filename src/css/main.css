...
.btn-primary:hover {
  ...
  box-shadow:0 8px 50px rgba(79,142,247,0.45);
}
.btn-outline {
...
.pc::after {
  ...
  background:radial-gradient(circle,var(--glow,rgba(79,142,247,0.06)) 0%,transparent 70%);
  pointer-events:none;
}
.pc:hover {
...
.pc-desc {
  font-size:13px;color:var(--text2);line-height:1.75;margin-bottom:22px;
  transition:color var(--tr);
}
.pc-tags {
...
.chatdemo-copy { padding-right:20px; }
.chatdemo-copy .ss { margin-bottom:28px; }
.chatdemo-feature {
...
.chat-widget {
  ...
  backdrop-filter:blur(20px);
  transition:background var(--tr),border var(--tr),box-shadow var(--tr);
}
.chat-header {
  background:linear-gradient(135deg,var(--blue2),var(--purple));
  padding:16px 20px;
...
.chat-typing {
  padding:4px 14px 4px;display:flex;align-items:center;gap:4px;
  display:none;
}
.chat-typing-dot {
  width:7px;height:7px;border-radius:50%;
  background:var(--text3);animation:typeDot 1.2s infinite;
}
...
.chat-send {
  ...
  display:flex;align-items:center;justify-content:center;
  color:#fff;font-size:16px;transition:opacity 0.2s,transform 0.2s;flex-shrink:0;
}
.chat-send:hover { opacity:0.85;transform:scale(1.05); }
.chat-send:disabled { opacity:0.4;cursor:not-allowed; }
.chat-disclaimer {
  text-align:center;font-size:10px;color:var(--text3);
  padding:0 16px 12px;transition:color var(--tr);
}
...
.mc-bar {
  ...
  background:linear-gradient(to top,var(--blue2),var(--blue));
  opacity:0.6;transition:opacity 0.2s;min-width:4px;
}
...
.pg-num {
  ...
  transition:all 0.3s,background var(--tr);
}
.pg-step:hover .pg-num {
...
.pg-title {
  ...
  margin-bottom:7px;transition:color var(--tr);
}
.pg-desc { font-size:11px;color:var(--text2);line-height:1.6;transition:color var(--tr); }

/* ── STATS BAND ───────────────────────────────────────────── */
#stats {
  background:linear-gradient(135deg,rgba(37,99,235,0.08),rgba(155,93,229,0.05));
  border-top:1px solid var(--border);
  border-bottom:1px solid var(--border);
  transition:border var(--tr);
}
...
.cfp-send {
  ...
  background:var(--blue);border:none;cursor:pointer;
  display:flex;align-items:center;justify-content:center;
  color:#fff;font-size:14px;transition:opacity 0.2s;flex-shrink:0;
}
...
@media(max-width:1000px) {
  ...
  .analytics-services { grid-column:span 2; }
...
@media(max-width:700px) {
  ...
  .hero-metrics { flex-direction:column;gap:0;border:none;background:none;align-items:stretch; }
  ...
  .chatdemo-grid { grid-template-columns:1fr; }
